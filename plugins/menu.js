...
let handler = async (m, { conn, usedPrefix, __dirname }) => {
  try {
    ...
    let url = 'https://i.ibb.co/FY3ps9m/20221124-203522.png'
...
`, text.trim(), flaa, [
    ...
    ], m, { 'document':{'url':'https://Reii-LinkTree.reiibotz.repl.co'},
...
contextInfo: { externalAdReply :{ showAdAttribution: true,
                        sourceUrl: 'https://Reii-LinkTree.reiibotz.repl.co',
                        mediaType: 2,
                        description: `⚘ Creator Not_Rei✓`,
                        title: `💌 My Ultah: ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`,
                        body: `⚘ by Not_Reii`,          previewType: 0,
                        thumbnail: await (await fetch(thumb)).buffer(),
                        mediaUrl: 'https://Reii-LinkTree.reiibotz.repl.co'
